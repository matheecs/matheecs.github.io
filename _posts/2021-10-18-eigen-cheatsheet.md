...
A(seqN(last, n, fix<-1>), all)     // A(lastN(n).reverse(), all)
...
// Eigen 3.4
M.reshaped(nrows,ncols)
M.reshaped<RowMajor>(nrows,ncols)
M.resize(Index,Index)              // Reshape In Place
