...
\begin{itemize}[parsep=0.5ex]
  \item Model Predictive Control (\textit{as a Motion Compiler})
...
\begin{itemize}[parsep=0.5ex]
  \item 理论基础: 线性代数，动力学，最优化，纤维丛%{GAMES103|104|105}
  \item 开发工具: C\texttt{++}/Python，CMake，Eigen，\textbf{Pinocchio}，\textbf{OSQP}，\textbf{MuJoCo}，\textbf{Drake}
  \item Favorite Things: Arduino, LEGO, Linux, Steam Deck, MacBook, Git, VSCode
\end{itemize}

\section{\faHeartO\ 个人荣誉}
\datedline{ICRA RoboMaster \textbf{全球季军}}{2019年}
