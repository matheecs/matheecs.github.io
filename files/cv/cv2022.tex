...
\begin{itemize}
	\item \textbf{状态估计}：视觉里程计、楼梯检测、实时构建局部稠密地图
	\item \textbf{轨迹规划}：任务决策、路径规划、轨迹优化
	\item \textbf{运动控制}：MPC、多刚体动力学仿真、电机控制FOC
\end{itemize}
\end{onehalfspacing}
...
\begin{itemize}[parsep=0.5ex]
  \item 研究方向: \{\textbf{机器狗，无人机，无人车}\} $\boldsymbol{\bigotimes}$ \{\textbf{规划，控制，估计}\}
  \item 软件工具: 掌握\textbf{C\texttt{++}}，Python，Linux，ROS 1/2，Drake，Apollo，Git
  \item 理论基础: 线性代数，微分方程，数值优化，最优控制，机器人学
\end{itemize}
