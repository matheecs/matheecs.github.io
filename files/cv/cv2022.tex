...
\begin{itemize}[parsep=0.5ex]
  \item 理论基础: 线性代数，刚体动力学，最优化%{GAMES103|104|105}
  \item 开发工具: C\texttt{++}/Python，CMake，Eigen，\textbf{Pinocchio}，\textbf{OSQP}，\textbf{MuJoCo}
  \item My Favorite Things: Arduino, LEGO, Linux, Steam Deck, MacBook, Git, VSCode
\end{itemize}
