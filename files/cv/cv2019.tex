...
\basicInfo{
  \email{zhangjixiang1995@qq.com} \textperiodcentered\ 
  \phone{(+86) 18883891249} \textperiodcentered\ 
  \homepage{https://matheecs.github.io}
}
 
\section{\faGraduationCap\  教育背景}
\datedsubsection{\textbf{西安交通大学}}{2017.9$\rightarrow${\,\,\,\,\,}Now}
\textbf{硕士}\ $\mathbf{GPA=3.79/4.00}$, 控制科学与工程(2020届)
...
\textbf{学士}\ $\mathbf{GPA=3.57/4.00}$, 电气工程及其自动化
...
\end{onehalfspacing}
\datedsubsection{\textbf{视觉SLAM/VIO/SfM理论研究与工程实践}}{2018.1$\rightarrow${\,\,\,\,\,}Now}
